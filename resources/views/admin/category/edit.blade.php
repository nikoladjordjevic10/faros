...
<div class="container">
  ...
  <div class="row py-5">
    <div class="col-12 d-flex flex-column flex-sm-row align-items-center justify-content-between">
      <img src="{{ asset('storage/uploads/proizvodi.jpg') }}" alt="Proizvodi" class="img-thumbnail mb-5 mb-sm-0" width="150"
        height="150">
      <h1 class="mb-5 mb-sm-0">Edit Category : {{ $category->name }}</h1>
